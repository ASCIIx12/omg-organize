  ...
  <div v-if="compact" class="mx-auto group shadow-md px-6 py-4 text-2xl flex justify-between hover:bg-gray-50">
    ...
    <span class="flex gap-2 invisible group-hover:visible">
      ...
      <span class="hidden sm:block hover:bg-red-50">
        <button type="button" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
